...
VENT_MAX        = int(os.getenv("VENT_MAX", 19)) #Vitesse de vent au delç de laquelle il est interdit de pulvériser"
VENT_DISPERSION_SEUIL2 = int(os.getenv("VENT_DISPERSION_SEUIL2", 11))
VENT_DISPERSION_MIN = int(os.getenv("VENT_DISPERSION_MIN", 5))
PLUIE_SEUIL     = float(os.getenv("PLUIE_SEUIL", 0))


# Méthode de discrétisation du risque
METHODE_SEUIL = "quartiles"  #Sinon, "valeurs"
VALEURS_SEUIL = 1,2,3  # Seuils (valeurs des 3 ift cumulé) permettant de créer les classes de risque
